...
public class DataSource {
    ...
    public static final Path path = FileSystems.getDefault().getPath("src\\main\\resources\\" + DB_NAME);
    public static final String CONNECTION_STRING = "jdbc:sqlite:" + path.toAbsolutePath().toString();
    ...
    public void checkPath() {
        System.out.println(path.toAbsolutePath().toString() + DB_NAME);
    }
