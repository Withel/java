...
public class Main {
    ...
    private static MobilePhone mobilePhone = new MobilePhone("0032 421 3332");
    ...
    public static void main(String[] args) {
        ...
        while(!quit){
            ...
            switch (action){
                ...
                default:
                    System.out.println("Select correct option. FUCKER");
    ...
    private static void updateContact(){
        ...
        if(mobilePhone.updatContact(existingContactRecord, newContact)){
