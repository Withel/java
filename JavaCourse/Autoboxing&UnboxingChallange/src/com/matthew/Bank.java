...
public class Bank {
    ...
    public boolean addCustomer(String branchName, String customerName,
        ...
        if(branch != null){
            return branch.newCustomer(customerName, initiaAmount);
        }
            ...
            for (int i =0;i<branchCustomers.size();i++){
                ...
                if (showTransactions){
                    ...
                    for (int j=0; j<transactions.size(); j++){
                        System.out.println("[" + (j+1) +"] Amount "+transactions.get(j)); //mozna dopisac .doubleValue, ale używany jest unboxing
